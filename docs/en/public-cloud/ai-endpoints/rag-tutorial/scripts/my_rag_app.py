...
def create_ovhcloud_rag():
    ...
    ovhcloud_knowledge = [
        ...
        Document(
            page_content="OVHcloud guarantees data sovereignty by ensuring your data stays within your chosen geographic region. Unlike providers who treat your data like a world traveler, OVHcloud keeps it exactly where you put it.",
...
def interactive_ovhcloud_chat():
    ...
    while True:
        ...
        try:
            ...
            print(f"OVHcloud Expert: {result['result']}")
